        ...
        <section className={`py-16 lg:py-20 ${darkMode ? 'bg-gray-900' : 'bg-gradient-to-b from-gray-50/50 to-white'}`}>
            <div className="main-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                    <div className={`scale-in p-6 sm:p-8 h-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 rounded-xl ${
                        darkMode
                    ...
                    <div className={`scale-in stagger-1 p-6 sm:p-8 h-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 rounded-xl ${
                        darkMode
                            ? 'bg-gray-800/50 backdrop-blur-sm shadow-gray-900/25 hover:shadow-gray-900/40'
                            : 'bg-white/70 backdrop-blur-sm shadow-blue-100/60 hover:shadow-blue-200/70'
                    }`} style={{
                    ...
                    <div className={`scale-in stagger-2 p-6 sm:p-8 h-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 rounded-xl ${
                        darkMode
                            ? 'bg-gray-800/50 backdrop-blur-sm shadow-gray-900/25 hover:shadow-gray-900/40'
                            : 'bg-white/70 backdrop-blur-sm shadow-blue-100/60 hover:shadow-blue-200/70'
                    }`} style={{
                    ...
                    <div className={`scale-in stagger-3 p-6 sm:p-8 h-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 rounded-xl ${
                        darkMode
                            ? 'bg-gray-800/50 backdrop-blur-sm shadow-gray-900/25 hover:shadow-gray-900/40'
                            : 'bg-white/70 backdrop-blur-sm shadow-blue-100/60 hover:shadow-blue-200/70'
                    }`} style={{
