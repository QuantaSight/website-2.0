        ...
        <section className={`py-12 md:py-16 lg:py-20 relative overflow-hidden ${
            ...
            <div className="main-container relative">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="slide-up stagger-1 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                    ...
                    <p className={`slide-up stagger-2 text-sm sm:text-base md:text-lg mb-8 leading-relaxed ${
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 max-w-2xl mx-auto">
                        <div className={`scale-in professional-card p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                            darkMode
                        ...
                        <div className={`scale-in stagger-1 professional-card p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                            darkMode
                                ? 'glass-dark shadow-gray-900/20'
                                : 'glass-light shadow-blue-100/40'
                        }`}>
                        ...
                        <div className={`scale-in stagger-2 professional-card p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                            darkMode
                                ? 'glass-dark shadow-gray-900/20'
                                : 'glass-light shadow-blue-100/40'
                        }`}>
