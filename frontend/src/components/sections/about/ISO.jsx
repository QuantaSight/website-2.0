                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    <div className="lg:w-1/3 flex justify-center">
                        <div className="scale-in relative">
                            ...
                            <div className={`slide-in-right absolute -top-2 -right-2 p-2 rounded-full shadow-lg ${
                                darkMode ? 'bg-green-500/20 text-green-400' : 'bg-green-100 text-green-700'
                            }`} style={{ transitionDelay: '0.1s' }}>
                                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5" />
                            </div>
                            <div className={`slide-in-left absolute -bottom-2 -left-2 p-2 rounded-full shadow-lg ${
                    ...
                    <div className="lg:w-2/3 text-center lg:text-left">
                        <h3 className={`slide-up text-lg sm:text-xl font-bold mb-6 ${
                            darkMode ? 'text-white' : 'text-gray-800'
                        }`}>
                            Enterprise-Grade Security & Quality Standards
                        </h3>

                        <p className={`slide-up stagger-1 text-sm sm:text-base mb-8 leading-relaxed ${
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                            <div className={`scale-in p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 ${
                        ...
                        <div className="slide-up stagger-2 flex flex-wrap justify-center lg:justify-start gap-3">
