        ...
        <section className={`py-16 lg:py-20 ${darkMode ? 'bg-gray-800' : 'bg-gradient-to-b from-white to-blue-50/30'}`}>
            <div className="main-container">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12">
                    <div className={`scale-in professional-card p-6 sm:p-8 h-full flex flex-col transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 ${
                        darkMode
                    ...
                    <div className={`scale-in stagger-1 professional-card p-6 sm:p-8 h-full flex flex-col transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 ${
                        darkMode
                            ? 'glass-dark shadow-gray-900/25 hover:shadow-gray-900/40'
                            : 'glass-card shadow-blue-100/60 hover:shadow-blue-200/70'
                    }`} style={{
                ...
                <div className={`scale-in professional-card p-6 sm:p-8 text-center transition-all duration-300 shadow-lg hover:shadow-xl ${
                    darkMode
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex justify-between items-start">
                            <div className="slide-in-left flex flex-col items-center text-left flex-1" style={{ transitionDelay: '0s' }}>
                            ...
                            <div className="slide-up stagger-3 flex flex-col items-center flex-1 mx-8">
                                <div className={`p-3 rounded-full mb-3 ${
                            ...
                            <div className="slide-in-right flex flex-col items-center text-right flex-1" style={{ transitionDelay: '0s' }}>
                                <div className={`p-3 rounded-full mb-3 ${
