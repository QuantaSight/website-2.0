                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        <div className={`p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                            ...
                            <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 mb-3 drop-shadow-sm mx-auto" />
                        ...
                        <div className={`p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                            ...
                            <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 mb-3 drop-shadow-sm mx-auto" />
                        ...
                        <div className={`p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                            ...
                            <div className="w-5 h-5 sm:w-6 sm:h-6 bg-purple-600 rounded mx-auto mb-3 flex items-center justify-center">
