...
const FeatureCard = ({ title, description, icon, badge, index }) => {
    return (
        <div className={`scale-in professional-card p-6 sm:p-8 h-full flex flex-col transition-all duration-300 hover:-translate-y-1 shadow-xl hover:shadow-2xl glass-card`} style={{
        ...
        <section className={`py-16 lg:py-20 ${darkMode ? 'bg-gray-900' : 'bg-gradient-to-b from-gray-50/50 to-white'}`}>
            <div className="main-container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 sm:mb-16">
                    <div className={`slide-in-right p-5 sm:p-6 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl ${
